      ...
      <div className="items-center grid gap-8 grid-cols-1 lg:grid-cols-2 lg:gap-40">
        <GenericText title="~$ cat experience">
          <p className="font-roboto">
            ...
            <a className="text-tertiary" href="https://trelion.nl">
              Trelion
            </a>
          ...
          <p className="font-roboto pt-2">
            ...
            in 2017, where in 2020 I graduated and got my
            &quot;ICT-Beheerder&quot; (MBO-4) degree. After that I started
            studying Network and System Engineering at the{" "}
            <a className="text-tertiary" href="https://www.thuas.com/">
              Hague University of Applied Sciences
            </a>{" "}
            where I graduated in 2024, and got my &quot;Bachelor of
            Science&quot; degree.
          </p>
          <p className="font-roboto">
